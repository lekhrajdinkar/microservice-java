package microservice.basicWebApp.courseApp.config;
...
@EnableJpaRepositories(
        basePackages = "microservice.basicWebApp.courseApp",
...
public class DatabaseConfig
{
    ...
    public DataSource getDataSource(
        ...
        log.info("DatabaseConfig :: Loading DataSource, driver - {}", driverClassName);
        ...
        log.info("DatabaseConfig :: Loading DataSource {}", retval);
