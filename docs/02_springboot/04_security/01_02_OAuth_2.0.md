## OAuth2.1
### Setup
- acct1 (ld)  : https://dev-16206041-admin.okta.com/admin/apps/active (use this only)
- acct2 (p4m) : for PY projects
- POC: [security App - readme.md](../../../src/main/java/microservice/securityApp/readme.md)
...
- **▶️PKCE** 
  ...
  - hashed value  of CV with RSA algo -> CC (`code verifier`)
  - Flow (2 steps):
